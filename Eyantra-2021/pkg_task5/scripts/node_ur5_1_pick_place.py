...
def main():
    ...
    # sorting pose so that 1st above package on shelf is dispatched
    for colour,pose in orders.colour_pose.items():
        orders.colour_pose[colour] = sorted(orders.colour_pose[colour])
